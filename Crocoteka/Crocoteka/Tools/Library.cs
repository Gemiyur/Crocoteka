...
/// </summary>
/// <remarks>
/// Книги, авторы, серии, переводчики.
/// </remarks>
public static class Library
{
    ...
    /// <summary>
    /// Возвращает имеет ли указанный жанр книги.
    /// </summary>
    ...
    /// <summary>
    /// Возвращает имеет ли указанная книга указанный жанр.
    /// </summary>
    /// <param name="book">Книга.</param>
    /// <param name="genreId">Идентификатор жанра.</param>
    ...
    /// <summary>
    /// Возвращает список книг с указанным жанром.
    /// </summary>
    /// <param name="genreId">Идентификатор жанра.</param>
    /// <returns>Список книг с указанным жанром.</returns>
    /// <remarks>Книги отсортированы по названию.</remarks>
